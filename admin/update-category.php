       ...
       ?>
        ...
        <table class="tbl-30">
                ...
                <tr>
                    <td>Активный: </td>
                    <td>
                        <input <?php if($featured=="Yes"){ echo "checked"; } ?> type="radio" name="active" value="Yes">Да
                        <input <?php if($featured=="No"){ echo "checked"; } ?> type="radio" name="active" value="No">Нет
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        if(isset($_POST['submit'])){
            ...
            if(isset($_FILES['image']['name'])){
                ...
                if($image_name!= ""){
                    ...
                    if($remove==false){
                        $_SESSION['failed-remove'] = "<div class='error'>Не удалось удалить текущее изображение</div>";
            ...
            $sql2 = "UPDATE tbl_category SET
                ...
                if($res2==true){
                    $_SESSION['update'] = "<div class='success'>Категория успешно обновлена</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                }else{
                    $_SESSION['update'] = "<div class='error'>Категория успешно обновлена</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                }
