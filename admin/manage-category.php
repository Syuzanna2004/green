        ...
        <table class="tbl-full">
            ...
            $sn=1;
                ...
                if($count>0){
                        ...
                        while($row=mysqli_fetch_assoc($res)){
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo SITEURL;?>admin/update-category.php?id=<?php echo $id; ?>" class="btn-secondary">Редактировать</a>
                        ...
                        ?>
                        <tr>
                            <td colspan="6"><div class="error">Категория не добавлена</div></td>
                        </tr>
                        <?php
                    }
